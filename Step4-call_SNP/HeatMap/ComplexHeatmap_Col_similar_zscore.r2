...
for (i in files){
	...
	if(ct == 1){
		...
		redcol<-length(mat_scaled_all)-white_col-piancha
		print (white_col)
		print (piancha)
		print (redcol)
		color1=(colorRampPalette(colors="white"))(white_col)
		col2 =(colorRampPalette(colors=c(rep("white"),"red")))(piancha)
		color2=(colorRampPalette(colors="red"))(redcol)
		my_col=c(color1,col2,color2)
	}
	if (ct == 1){
