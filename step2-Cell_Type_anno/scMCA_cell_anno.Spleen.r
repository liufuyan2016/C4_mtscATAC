...
scATAC=readRDS("/jdfsbjcas1/ST_BJ/P21H28400N0232/kangjingmin/project/01.Mt_sc/10.Article/04.Distribution/01.Old/03.Cluster_SignalC/01.P_TSNE_50/P_combined.harmony_GeneActivityLogNormalize.rds")
...
library(ggplot2)
  ...
  c3=DimPlot(object = scATAC, label = TRUE, group.by = "predicated.cell.type") +
